...
export class DetailsCardComponent implements OnInit {
  ...
  async getAlbum(spotify_result:any){
    var album_url = ("http://localhost:8080/getAlbum?artistId="+spotify_result.artists.items[0].id);
  ...
  //   var spotify_url="";
  //   var spotify_url = ("http://localhost:8080/getSpotify?attraction="+this.eventsItem._embedded.attractions[0].name);
  ...
  ngOnInit(): void {
   ...
   //google-map
    ...
    // var album_url = ("http://localhost:8080/getAlbum?artistId"+this.spotifyResult.artists.items[0].id);
